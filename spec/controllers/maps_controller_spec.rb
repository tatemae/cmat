...
describe Api::MapsController do
  ...
  describe "GET new" do
    it "assigns a new api_map as @api_map" do
      get :new, {}, valid_session
      assigns(:api_map).should be_a_new(Api::Map)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created api_map as @api_map" do
        post :create, {:api_map => valid_attributes}, valid_session
        assigns(:api_map).should be_a(Api::Map)
        assigns(:api_map).should be_persisted
      end

      it "redirects to the created api_map" do
        post :create, {:api_map => valid_attributes}, valid_session
        response.should redirect_to(Api::Map.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved api_map as @api_map" do
        ...
        Api::Map.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested api_map" do
        ...
        # specifies that the Api::Map created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Api::Map.any_instance.should_receive(:update).with({ "these" => "params" })
