...
describe Api::MapsController do
  ...
  let(:valid_attributes) { { title: 'test', user: user } }
  ...
  describe "GET index" do
    it "assigns all maps as @maps" do
      ...
      get :index, {format: :json}.merge(valid_session)
  ...
  describe "GET show" do
    it "assigns the requested map as @map" do
      map = Map.create! valid_attributes
      get :show, {:id => map.to_param, format: :json}.merge(valid_session)
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Map" do
        expect {
          post :create, {:map => valid_attributes, format: :json}.merge(valid_session)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved map as @map" do
        ...
        post :create, {:map => { fake: "param" }, format: :json}.merge(valid_session)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested map" do
        ...
        put :update, {:id => map.id, :map => { "title" => "a title" }, format: :json}.merge(valid_session)
      end

      it "assigns the requested map as @map" do
        map = Map.create! valid_attributes
        put :update, {:id => map.to_param, :map => valid_attributes, format: :json}.merge(valid_session)
        assigns(:map).should eq(map)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the map as @map" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Map.any_instance.stub(:save).and_return(false)
        put :update, {:id => map.id, :map => { fake: "param" }, format: :json}.merge(valid_session)
        assigns(:map).should eq(map)
      end
    end
  end
  ...
  describe "DELETE destroy" do
    it "destroys the requested map" do
      map = Map.create! valid_attributes
      expect {
        delete :destroy, {:id => map.to_param, format: :json}.merge(valid_session)
      }.to change(Map, :count).by(-1)
    end
  end
